/**
 * 格式化时间
 * dateFormat()                           //2018-08-08 08:08:08
 * dateFormat('YYYY-MM-DD HH:mm:ss SSS')  //2018-08-08 08:08:08 888
 * dateFormat('YY-M-D H:m:s')             //18-8-8 8:8:8
 * dateFormat('default')                  //2018-08-08 08:08:08
 * dateFormat('YYYY-MM-DD')               //2018-08-08
 * dateFormat('date')                     //2018-08-08
 * dateFormat('HH:mm:ss')                 //08:08:08
 * dateFormat('time')                     //08:08:08
 * dateFormat(new Date())                 //2018-08-08 08:08:08
 * dateFormat(Date.now())                 //2018-08-08 08:08:08
 */
